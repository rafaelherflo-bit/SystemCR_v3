...
<div class="container-fluid">
  <ul class="full-box list-unstyled page-nav-tabs">
    ...
    <li>
      <a class="active"><i class="fas fa-list"></i> &nbsp; LISTA</a>
    </li>
    <li>
...
<div class="container-fluid table-responsive">
  <table class="dataTable table-sm table-hover table table-secondary table-striped-columns">
    ...
    <tbody>
      <?php
      $QRYcotM = consultaData("SELECT * FROM cotizadorM WHERE cotM_estatus = 1");
      if ($QRYcotM['numRows'] >= 1) {
        foreach ($QRYcotM['dataFetch'] as $rowM) {
          ...
          if ($fecha_actual <= $fecha_limite) {
            ...
            $caducidad = "El registro ha caducado.";
      ...
      ?>
          <tr>
            ...
            <td><?= $caducidad; ?></td>
            <td>
              <?php if ($rowM['cotM_estatus'] == 1) { ?>
                <span class="btn btn-success btnPDF" data-id="<?= encryption($rowM['cotM_id']); ?>"><i class="fas fa-file-pdf"></i></span>
                <!-- <span class="btn btn-warning btnEditar" data-id="<?= encryption($rowM['cotM_id']); ?>"><i class="fas fa-pen"></i></span> -->
