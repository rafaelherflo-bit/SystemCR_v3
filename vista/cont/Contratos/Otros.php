<?php
$consulta = "SELECT 
                C.*, CL.cliente_rs, CL.cliente_rfc,
            ...
            WHERE C.contrato_estado = 'Cancelado'
...
<div class="container-fluid mb-4">
  <div class="d-flex justify-content-between align-items-center bg-white p-3 shadow-sm rounded">
    <h5 class="m-0 fw-bold text-dark"><i class="fas fa-file-contract me-2 text-primary"></i>Listado de Contratos Inactivos</h5>
    <div class="btn-group">
      ...
      <a href="<?= SERVERURL; ?>Contratos/Lista" class="btn btn-outline-success btn-sm">
      ...
      <div class="table-responsive">
        <table class="dataTable table-sm table-hover table table-secondary">
          <thead class="table-dark">
            <tr>
              <th style="text-align: center;" class="ps-4">FOLIO & CLIENTE</th>
              ...
              foreach ($query['dataFetch'] as $row): ?>
                <tr>
                  ...
                  <td style="max-width: 450px;">
                    ...
                    $rentas = consultaData("SELECT renta_id, renta_folio, renta_estado FROM Rentas WHERE renta_contrato_id = " . $row['contrato_id']);
                    ...
                    ?>
                      <a href="<?= SERVERURL ?>Rentas/Detalles/<?= encryption($r['renta_id']) ?>"
                        class="btn <?= $btnClass ?> btn-xs fw-bold"
                        style="font-size: 0.7rem;" target="_blank">
                        <?= $row['contrato_folio'] ?>-<?= $r['renta_folio'] ?>
                      </a>
                    <?php endforeach; ?>
                  </td>
