...
<div class="container-fluid">
  <ul class="full-box list-unstyled page-nav-tabs">
    <li>
      <a class="active" class=""><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CONTRATO</a>
    </li>
    <li>
      <a href="<?= SERVERURL; ?>Contratos/Lista"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CONTRATOS</a>
    </li>
    <li>
      <a href="<?= SERVERURL; ?>Contratos/Otros"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; NO ACTIVOS</a>
    </li>
  </ul>
</div>
...
<div class="container-fluid">
  <form class="form-neon FormularioAjax" action="<?= SERVERURL; ?>ajax/controllerAjax.php" method="post" data-form="save" autocomplete="off">
    <input type="hidden" name="nuevoContrato" value="1">
    <fieldset>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="form-group">
              <label for="fecha_inicio" class="bmd-label-floating">FECHA DE INICIO</label>
              <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" value="<?= date("Y-m-d"); ?>">
            </div>
          </div>
          <div class="col-12 col-md-8">
            <div class="form-group">
              <label for="cliente_id" class="bmd-label-floating">CLIENTE</label>
              <select class="form-select" id="cliente_id" name="cliente_id" data-placeholder="Selecciona un Cliente">
                <option></option>
                <?php
        ...
        <div class="row">
          <div class="col-12 col-md-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" list="contacto_list" id="contacto" name="contacto" maxlength="50" pattern="[a-zA-Z ?.?]{5,50}">
          ...
          <div class="col-12 col-md-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" list="telefono_list" id="telefono" name="telefono" maxlength="50" pattern="[0-9]{0,15}">
        ...
        <input type="hidden" id="renta_coor" name="renta_coor">
        <div id="map_addContrato" class="row">
        </div>
          ...
          <div class="row">
            ...
            <div class="col-12" id="col_lectura_col">
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="lectura_col" name="lectura_col" maxlength="50">
              </div>
            </div>
          </div>
        </div>
