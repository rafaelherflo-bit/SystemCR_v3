    ...
    <fieldset class="form-neon">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12 col-md-2">
            <div class="form-group">
              ...
              <input type="datetime-local" class="form-control" name="reporte_fecha_inicio" value="<?= $Data['reporte_fecha']; ?>">
            </div>
          </div>
          <div class="col-12 col-md-2">
            <div class="form-group">
              <label for="reporte_fecha_fin" class="bmd-label-floating">FINAL</label>
              <input type="datetime-local" class="form-control" name="reporte_fecha_fin" value="<?= $Data['reporte_fecha']; ?>">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col" id="col_renta_stock_C" <?= ($Data['modelo_tipo'] == "Monocromatico") ? 'style="display: none;"' : ''; ?>>
            <div class="form-group">
          ...
          <div class="col" id="col_renta_stock_Y" <?= ($Data['modelo_tipo'] == "Monocromatico") ? 'style="display: none;"' : ''; ?>>
            <div class="form-group">
          ...
          <div class="col" id="col_renta_stock_R" <?= ($Data['modelo_tipo'] == "Monocromatico") ? 'style="display: none;"' : ''; ?>>
            <div class="form-group">
