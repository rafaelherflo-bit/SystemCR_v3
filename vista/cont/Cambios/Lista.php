...
<div class="container-fluid">
  <ul class="full-box list-unstyled page-nav-tabs">
    ...
    <li>
      <a class="active" class=""><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; TODAS</a>
    </li>
    <li>
    ...
    <tbody>
      ...
      ?>
          <tr>
            ...
            <td><?= ucfirst(dateFormat($row['cambio_fecha'], "numeros")); ?></td>
            <td>
              <?= $row['cliente_rs'] . " (" . $row['cliente_rfc'] . ") <br> " . $row['contrato_folio'] . "-" . $row['renta_folio'] . " | " . $row['renta_depto'] . "<br>Zona: " . $row['zona_nombre']; ?>
            </td>
