<div class="container-fluid">
  <fieldset class="form-neon container-fluid">
    <form class="FormularioAjax" action="<?= SERVERURL; ?>ajax/controllerAjax.php" method="post" data-form="save" autocomplete="off">
      <input type="hidden" name="nuevoRegistro_AlmP" value="<?= encryption("Chips"); ?>">
      <center>
        ...
        <div class="row">
          <div class="col-12 col-md">
            <div class="form-group">
              <label for="tonerCodigo1" class="bmd-label-floating">MARCA DE CHIP</label>
          ...
          <div class="col-12 col-md">
            <div class="form-group">
              ...
              <input type="number" class="form-control" list="tonerCodigos" id="tonerCodigo2" name="tonerCodigo2" maxlength="50" pattern="^([0-9]{3,5})$" required>
