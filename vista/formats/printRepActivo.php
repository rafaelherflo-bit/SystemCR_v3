...
WHERE reporte_id = " . decryption($_POST['reporte_id']);
$QRY = consultaData($SQL);
if ($QRY['numRows'] > 1 || $QRY['numRows'] == 0) {
    redirect($redirect);
} else {
...
$pdf->Cell(0, 8, 'SERVICIO DE RENTA', 0, 1, 'C');
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(80, 6, utf8_decode($Data['contrato_folio'] . "-" . $Data['renta_folio'] . " | " . $Data['renta_depto']), 1, 0, 'C');
$pdf->SetFont('Arial', 'B', 10);
...
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(53, 6, utf8_decode(strtoupper(dateFormat($Data['reporte_fecha'], "simple")) . "  " . explode(" ", $Data['reporte_fecha'])[1]), 1, 0, 'C');
$pdf->Cell(36, 6, utf8_decode($Data['reporte_wmakes']), 1, 0, 'C');
...
if ($Data['modelo_tipo'] == "Multicolor") {
    ...
    $pdf->SetFont('Arial', 'B', 14);
    $pdf->Cell(15, 8, '', 0, 0, 'C');
    $pdf->Cell(80, 8, 'DATOS DEL EQUIPO', 0, 0, 'C');
    $pdf->SetFont('Arial', 'B', 11);
    $pdf->Cell(35, 7, 'CONTADORES', 0, 0, 'C');
    $pdf->Cell(25, 7, 'ESCANEO', 1, 0, 'C', true);
    $pdf->Cell(25, 7, 'B&N', 1, 1, 'C', true);
}
...
if ($Data['modelo_tipo'] == "Multicolor") {
    ...
    $pdf->Cell(45, 7, utf8_decode($Data['modelo_linea'] . " " . $Data['modelo_modelo']), 0, 0, 'L');
    ...
    $pdf->Cell(25, 7, 'MODELO:', 0, 0, 'R');
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(55, 7, utf8_decode($Data['modelo_linea'] . " " . $Data['modelo_modelo']), 0, 0, 'L');
    $pdf->Cell(35, 7, 'INICIAL', 1, 0, 'C', true);
    $pdf->Cell(25, 7, "", 1, 0, 'L');
    $pdf->Cell(25, 7, "", 1, 1, 'L');
}
...
if ($Data['modelo_tipo'] == "Multicolor") {
    ...
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(45, 7, utf8_decode($Data['equipo_serie']), 0, 0, 'L');
    ...
    $pdf->Cell(25, 7, 'NO. DE SERIE:', 0, 0, 'R');
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(55, 7, utf8_decode($Data['equipo_serie']), 0, 0, 'L');
    $pdf->Cell(35, 7, 'FINAL', 1, 0, 'C', true);
    $pdf->Cell(25, 7, "", 1, 0, 'L');
    $pdf->Cell(25, 7, "", 1, 1, 'L');
}
...
if ($Data['modelo_tipo'] == "Multicolor") {
    ...
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(45, 7, utf8_decode($Data['equipo_codigo']), 0, 0, 'L');
    ...
    $pdf->Cell(25, 7, 'NO. DE EQUIPO:', 0, 0, 'R');
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(55, 7, utf8_decode($Data['equipo_codigo']), 0, 0, 'L');
    $pdf->SetFont('Arial', 'B', 11); // ABASTECIMIENTO
    $pdf->Cell(35, 7, 'NIVELES', 0, 0, 'C');
    $pdf->Cell(25, 7, "K", 1, 0, 'C', true);
    $pdf->Cell(25, 7, "R", 1, 1, 'C', true);
}
...
if ($Data['modelo_tipo'] == "Multicolor") {
    ...
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(45, 7, utf8_decode($Data['modelo_toner']), 0, 0, 'L');
    $pdf->Cell(35, 7, 'INICIAL', 1, 0, 'C', true);
    $pdf->Cell(15, 7, "", 1, 0, 'L');
    $pdf->Cell(15, 7, "", 1, 0, 'L');
    $pdf->Cell(15, 7, "", 1, 0, 'L');
    ...
    $pdf->Cell(25, 7, 'MOD. TONER:', 0, 0, 'R');
    $pdf->SetFont('Arial', '', 11);
    $pdf->Cell(55, 7, utf8_decode($Data['modelo_toner']), 0, 0, 'L');
    $pdf->Cell(35, 7, 'INICIAL', 1, 0, 'C', true);
    $pdf->Cell(25, 7, "", 1, 0, 'L');
    $pdf->Cell(25, 7, "", 1, 1, 'L');
}
...
$pdf->MultiCell(180, 5, utf8_decode(utf8_decode($Data['reporte_reporte'])), 0, 'L');
...
$pdf->Output('I', utf8_decode("ReporteDeServicioActivo.pdf"));
