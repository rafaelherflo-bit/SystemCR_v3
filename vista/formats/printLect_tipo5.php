...
// ==================================================================================================================================================================== //
if (file_exists(SERVERDIR . "DocsCR/Lecturas/" . $currYear . "/" . $currMonthNumber . "/Formatos" . "/" . $_POST['curr_lectura_id'] . ".jpg")) {
    $pdf->AddPage();
    $imgDir_actual = SERVERDIR . "DocsCR/Lecturas/" . $currYear . "/" . $currMonthNumber . "/Formatos" . "/" . $_POST['curr_lectura_id'] . ".jpg";
    $pdf->Image($imgDir_actual, 2, 10, 210, 290, "JPEG");
}
if (file_exists(SERVERDIR . "DocsCR/Lecturas/" . $currYear . "/" . $currMonthNumber . "/PE" . "/" . $_POST['curr_lectura_id'] . ".jpg")) {
    $pdf->AddPage();
    $imgDir_actual = SERVERDIR . "DocsCR/Lecturas/" . $currYear . "/" . $currMonthNumber . "/PE" . "/" . $_POST['curr_lectura_id'] . ".jpg";
    $pdf->Image($imgDir_actual, 2, 10, 210, 290, "JPEG");
}
...
if (file_exists(SERVERDIR . "DocsCR/Lecturas/" . $prevYear . "/" . $prevMonthNumber . "/PE" . "/" . $_POST['prev_lectura_id'] . ".jpg")) {
    $pdf->AddPage();
    $imgDir_actual = SERVERDIR . "DocsCR/Lecturas/" . $prevYear . "/" . $prevMonthNumber . "/PE" . "/" . $_POST['prev_lectura_id'] . ".jpg";
    $pdf->Image($imgDir_actual, 2, 10, 210, 290, "JPEG");
}
